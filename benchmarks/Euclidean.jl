...
function benchmark_euclidean_exp(; n::Int = 64, batch::Int = 4096, samples::Int = 6, seed::Int = 1234)
    data = _setup_euclidean_data(; n = n, k = 1, batch = batch, seed = seed)
...
function main()
    ...
    println()
    benchmark_euclidean_exp(; n = n, k = 1, batch = batch, samples = samples)
    println()
    benchmark_euclidean_log(; n = n, k = 1, batch = batch, samples = samples)
    println()
    benchmark_euclidean_distance(; n = n, k = 1, batch = batch, samples = samples)
    println()
    benchmark_euclidean_inner(; n = n, k = 1, batch = batch, samples = samples)
    println()
    benchmark_euclidean_norm(; n = n, k = 1, batch = batch, samples = samples)
    println()
    return benchmark_euclidean_parallel_transport(; n = n, k = 1, batch = batch, samples = samples)
end
